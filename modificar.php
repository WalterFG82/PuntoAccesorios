...
<html lang="en">
    ...
    <body>
        ...
        <form action="listar.php" method="post" enctype="multipart/form-data"> <!-- acá no ponemos ningún archivo en action porque esta todo en el mismo archivo.. -->
            ...
            <button type="submit" name="Cancelar" formaction="index.php">Cancelar</button>
        </form>
        <?php
